...
//        }
    ...
    public HashMap<Integer, String> sendMessage()
    {
        ...
        for(Iterator itr = c.iterator(); itr.hasNext(); ){
            ...
            double[] bb = Features.boundingBox(obj.points);
            ...
            String colorInput = Features.getFeatureString(obj, FeatureCategory.COLOR);
            String shapeInput = Features.getFeatureString(obj, FeatureCategory.SHAPE);
